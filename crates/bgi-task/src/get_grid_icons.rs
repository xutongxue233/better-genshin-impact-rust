...
pub fn plan_get_grid_icons(
    ...
    Ok(GetGridIconsExecutionPlan {
        ...
        pending_native: vec![
            ...
            "desktop live adapters are partially wired for ordinary item-name WinRT OCR, ArtifactSetFilter flower-name WinRT double-OCR selection, ArtifactSetFilter 60x60-to-125x125 icon crop execution, and optional star color-component suffix detection; Paddle OCR parity, ArtifactSetFilter detail-page retry scrolling, and overlay cleanup remain pending".to_string(),

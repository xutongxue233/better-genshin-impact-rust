...
pub fn plan_go_to_serenitea_pot(
    ...
    Ok(GoToSereniteaPotExecutionPlan {
        ...
        finish_rule,
        steps,
        notes: "Serenitea Pot entry, A Yuan search, reward claim, realm-depot purchase, and final teleport are represented and executable as a Rust state machine through injectable hooks; direct map, OCR, click, shop, and path execution remain pending."
            .to_string(),
    })
}
